...
public class OneToManyBuilder {
	...
	public void put(String parentName, String entryName, String comment){
		//构造简单的实体类
		Entry parentEntry = new Entry(parentName, "");
		...
		oneToManyStr += "\t@OneToMany(cascade={javax.persistence.CascadeType.REMOVE}"+ lazyProp +", mappedBy=\""+ parentEntry.getLowerName() +"\")\n";
		oneToManyStr += "\t@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE, region=\"hibernateEntryListCache\")\n";
